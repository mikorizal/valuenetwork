...
urlpatterns = [
    ...
    url(r"^resource/(?P<resource_id>\d+)/$", valuenetwork.valueaccounting.views.resource,
        name="resource"),
    url(r"^resource-pictures/(?P<resource_id>\d+)/$", valuenetwork.valueaccounting.views.resource_pictures,
        name="resource_pictures"),
    url(r"^add-resource-picture/(?P<resource_id>\d+)/$", valuenetwork.valueaccounting.views.add_resource_picture,
        name="add_resource_picture"),
